...
public class Main {
    ...
    private static void cadastrarLivro() {
        ...
        livroCriado.setAutor(entrada.nextLine());

        System.out.println("Editora: ");
        livroCriado.setEditora(entrada.nextLine());

        System.out.println("Gênero do livro: ");
        livroCriado.setGenero(entrada.nextLine());
    ...
    private static void cadastrarUsuario() {
        ...
        pessoaNova.setNumero(entrada.nextLine());
